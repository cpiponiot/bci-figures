...
The DBH of stems measured above 1.3 m was corrected for taper with the generic equation from @Cushman2014; the corrected DBH is stored in the `dbh_t`column and the corresponding aboveground biomass in the `agb_t`column. 
