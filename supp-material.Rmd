...
df_stem_melt <- merge(df_stem_melt, bci_habitat[, c("q20", "habitat")], by = "q20", all.x = TRUE)

# aggregate, unit area = area of a quadrat (in ha)
df_hab <- aggregate_agb_dyn("habitat", area = 0.04, nboot = 1000)
...
save(df_plot, df_size, df_pft, df_pft2, df_ind, df_hab, df_crown, df_crown_hab, file = "cache.rda")
```
