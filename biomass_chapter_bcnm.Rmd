...
Word count (not including abstract, section titles and figure legends): 2405

**Abstract** Tropical forest biomass, and the carbon it contains, is of increasing interest to the international community, particularly for its role in climate change. To understand changes in tropical forest biomass and the underlying mechanisms, long-term forest plots are needed, which are relatively rare in the tropics. The 50 ha forest plot on Barro Colorado Island is outstanding in many ways: in its size, temporal extent (35 years of inventories), and sampling intensity (all trees larger than 1 cm in diameter were measured). In this chapter, we explore the methods used to calculate its aboveground biomass and woody productivity, as well as their spatial distribution within the plot, temporal variation, and distribution among trees of different sizes and functional groups.
