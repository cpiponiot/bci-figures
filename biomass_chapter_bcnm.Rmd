...
In addition to biomass stocks, ecologists are also interested in biomass dynamics: changes in biomass over time, which is the net difference between biomass increase due to tree productivity and biomass loss due to tree mortality. Annual mortality is calculated as the biomass of all dead trees between two censuses, divided by the time period between the two censuses. Annual productivity is the annualized sum of the increase in biomass of living trees between two censuses, and the biomass of recruited trees, i.e., trees that were measured for the first time in the last census. These measures are underestimated for two reasons: (i) they do not account for branch turnover, which can be high in the tropics (ref), and (ii) some stems are recruited and die between two censuses, and are therefore never measured. A correction for the latter source of bias has been proposed by @Kohyama2019 and does not require additional measurements (applied in Figure \@ref(fig:fig2-correc)d).

* Complications of nonstandard height of measurement, data QAQC

The standard height for measuring tree diameter is 1.3 m (referred to as diameter at breast height, or DBH), and the vast majority of biomass allometries are calibrated with diameter values at 1.3 m. However, tree diameter is sometimes measured at a different height, for example because of trunk irregularity at 1.3 m height in buttressed trees; due to tree taper, this can lead to underestimation of tree diameter and thus biomass. Change in height of measurement, among other factors such as errors in DBH measurement and reporting, irregular or thorny trunks, and the presence of lianas or strangling figs [@Sheil1995] can lead to outlier values for change in diameter. The cause of these outliers is usually difficult to trace back, making correction difficult, with multiple possible correction procedures that are all subject to bias [@Muller-Landau2014]. Dealing with nonstandard height of measurement can be done by multiplying the measured diameter by a 'taper-correction' factor; such a model has been calibrated with data from BCI [@Cushman2014; see "taper correction" in Figure \@ref(fig:fig2-correc)]. Dealing with outlier changes in diameter can be done by substutiting the outlier values by mean growth of stems with similar characteristics (e.g., similar diameter; see "outlier substitution" in Figure \@ref(fig:fig2-correc)). 
...
The fate of carbon storage in tropical forest biomass under climate change is still uncertain. Factors such as increased availability of atmospheric carbon dioxide may increase tree productivity, but there is also growing evidence that rising temperature and frequency of extreme droughts are causing increased tree mortality [ref].Permanent tropical forest plots such as the BCI, which provide a great temporal depth of data on forest biomass stocks and fluxes (productivity, mortality), are therefore essential to assess whether these stocks and fluxes are increasing or decreasing over time, and to evaluate their relationship to climate. Estimates and temporal trends of BCI biomass stocks and fluxes varied over time depending on the allometric equations used and the data correction procedure (Table 1, Figure \@ref(fig:fig1-allom), Figure \@ref(fig:fig2-correc)). Overall, there is no evidence of a systematic directional change in BCI biomass stocks and fluxes, although biomass stocks and fluxes show strong temporal variation. (Figure \@ref(fig:fig1-allom)).


* Contributions to tree AGB stocks and fluxes by subgroups

Trees have different ecological roles depending on their characteristics: size, canopy stature, growth rates, etc. In particular, trees' characteristics can influence their relative contribution to biomass stocks and fluxes. It has been shown for example that small sized trees contribute relatively more to productivity than to total biomass [Figure \@ref(fig:fig3-groups); @Piponiot2021;@Meakem2018]. xx some elements on functional groups depending on the one we chose for figure 3.



*	Spatial variation in BCI AGB stocks and fluxes – within BCI 50 ha plot 

    + Variation within the 50 ha plot among topographically defined habitats > Chave ? 
...
*	Spatial variation in BCNM AGB stocks and fluxes from multiple plots, and experimental results 
    ...
    + 50 ha plot is not representative of whole island much less whole  BCNM 
