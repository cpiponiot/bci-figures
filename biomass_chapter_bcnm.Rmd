...
Word count (not including section titles and figure legends): 2070 

# Introduction

Biomass is the mass of all living things in an ecosystem, and is usually measured on oven-dried material, thus excluding water. The biomass of a forest is dominated by the aboveground woody parts of the trees, mainly the trunks and branches [@Muller-Landau2021; RSR: @Qi2019;@Jackson1996; exs partition of total carbon stocks: @Zekeng2020;@Sierra2007]. It was rarely considered in ecology until about 30 years ago, but has recently received much attention due to increased interest in the global carbon cycle and the crucial role of forests in this cycle [@Brown1982]. This has led to an increase in the number of papers calculating forest biomass stocks and biomass fluxes associated with tree growth and mortality [@Huang2020].

The traditional method of estimating tree biomass is to measure the basic characteristics (such as diameter) of all trees in a given area, and derive an estimate of biomass. On Barro Colorado Island, a 50-ha plot was established in 1980 to regularly measure all stems from 1 cm in diameter upward, allowing for an extensive estimate of woody biomass in the plot and its changes over time. In this chapter, we will explore the results of 35 years of measurements on the plot, focusing on aboveground biomass stocks and fluxes: how to estimate them, their temporal and spatial variation on the plot, and their distribution into size and functional groups. We will then briefly present other woody biomass stocks and fluxes, including root and liana biomass. Landscape-level biomass variation in Barro Colorado National Monument from other smaller forest plots and from remote sensing is presented in Chapters xx and xx respectively. The effects of experimental manipulations (Gigante fertilization experiments; addition or removal of litter; liana removal) on forest biomass are presented in Chapters xx, xx, and xx respectively. 
...
# make panel labels 
dflabs <- data.frame(variable = levels(dfcorr$variable), label = letters[5:6])
...
Biomass stocks and fluxes exhibit high small-scale spatial variability in the 50 ha BCI plot [@Rejou-Mechain2014]. This high spatial noise in the data makes it difficult to identify clear patterns in the spatial distribution of biomass within the 50 ha plot (Figure \@ref(fig:fig4-spatial)), however some differences across topographically-defined habitats and soil types have been detected [Figure \@ref(fig:fig4-spatial)b,d; @Chave2003;@DeWalt2004]. In particular, the high plateau and slope forests of the plot have both higher aboveground biomass and aboveground woody productivity (Figure \@ref(fig:fig4-spatial)). The swamp area of the plot has high aboveground biomass, but relatively low biomass productivity; this is due to the lack of palm height data (mentioned above), resulting in zero estimated productivity for most palm species. Finally, a small portion of the 50-ha plot is composed of secondary forest (young forests in Figure \@ref(fig:fig4-spatial)) and has thus lower aboveground biomass. 

```{r, fig4-spatial, fig.height = 8, fig.width = 12, fig.cap="Crown-distributed AGB (Mg/ha) and AWP (Mg/ha/yr) on the 50 ha plot, grouped by topographically-defined habitat [as defined by @Harms2001]. (a-b) Map of crown-distributed (a) AGB in the 2010 census and (b) AWP between the 2010 and 2015 censuses. Colors delineate the topographically defined habitats. (c-d) Mean (+/- standard errors of the means over 20 m quadrats) of (c) AGB and (d) AWP in each topographically defined habitat. The AGB and AWP of individual trees were distributed among 2x2m pixels in proportion to the area of intersection between the pixel and the tree crown [crown radius calculated according to @MartinezCano2019]. The AGB and AWP of the portions of tree crowns that lie outside the edges were mirror-transposed into the pixels inside the plot to avoid underestimation of AGB and AWP at the edges of the plot (see Supplementary material). Differences among topographically-defined habitats are consistent with results from @Chave2003."}
...
The 50 ha plot is not representative of the island of Barro Colorado, let alone the entire Barro Colorado National Monument: it is located in a particularly flat part of the island, with a relatively homogeneous geological substrate and fairly old forest compared to the rest of the island [@Baillie2006;@Mascaro2011; Chapter xx]. Results from other smaller plots distributed throughout Barro Colorado National Monument and remote sensing show that the 50 ha plot has a higher average biomass (? check info + other differences?) than the rest of Barro Colorado National Monument (Chapters xx and xx). 

<!-- * Importance of other biomass pools  -->

The aboveground woody biomass estimates provided in this chapter omit some forest biomass pools, which may vary in importance but are all relatively difficult to estimate accurately. Direct estimates of root biomass, which is probably the largest omitted biomass stock, require labor-intensive destructive sampling [@Addo-Danso2016]. Root biomass is therefore often estimated as a proportion of above-ground biomass, although this proportion varies greatly among study sites [@Addo-Danso2016;@Qi2019]. To date, there is no site-specific below-aboveground biomass ratio for BCI; average ratios of below-to-aboveground biomass in tropical forests vary between 20-31% in the literature [@Anderson-Teixeira2016;@Qi2019], which would result in a root biomass of about 60-90 Mg/ha in the Barro Colorado Island 50 ha plot [xx better allometries  from Agua Salud? see @Sinacore2017 > ratio is 37%]. The biomass of lianas is also difficult to estimate, mainly due to the irregularity of their shape which makes it difficult to estimate their biomass from simple measurements such as their diameter. Two complete censuses of lianas on the 50 ha plot have already been conducted and show that lianas account for only 3% of the basal area of all woody plants, and xx% of the total aboveground biomass (@Schnitzer2012;@Schnitzer2021; Chapter XX). [Saplings & trees < 1cm dbh?] Finally, non-woody biomass (leaves, flowers and fruits) generally represents 2-4% of the total aboveground biomass in mature tropical forests [@Anderson-Teixeira2016;@Chave2010;@Muller-Landau2021]. 

> Conclusion? Perspectives referencing other chapters?
