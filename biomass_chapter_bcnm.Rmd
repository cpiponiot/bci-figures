...
Biomass stocks and fluxes exhibit high small-scale spatial variability in the BCI 50 ha plot [@Rejou-Mechain2014]. This is especially true when all stocks and fluxes for a tree are assigned to the location of the trunk; the noisiness decreases when they are instead distributed across the estimated crown area (Figure \@ref(fig:fig4-spatial)a,b).  Topographically-defined habitats differ systematically in biomass and productivity [@Chave2003]. In particular, the high plateau and slope forests of the plot have both higher aboveground biomass and aboveground woody productivity (Figure \@ref(fig:fig4-spatial)). The swamp area of the plot has high estimated aboveground biomass, and low estimated biomass productivity, but this is an artefact of the way biomass and biomass productivity are estimated for palms in the absence of palm height data (mentioned above), combined with the high abundance of oil palms with very short stems in this area. In reality, biomass stocks in this area are considerably lower, and productivity is higher. A small portion of the 50-ha plot is composed of secondary forest (young forests in pink in Figure 4) and has thus lower aboveground biomass.

```{r, fig4-spatial, fig.height = 8, fig.width = 12, fig.cap="Crown-distributed AGB (Mg/ha) and AWP (Mg/ha/yr) on the 50 ha plot, with habitat divisions as defined by @Harms2001. (a-b) Map of crown-distributed (a) AGB in the 2010 census and (b) AWP between the 2010 and 2015 censuses. Colors delineate the topographically defined habitats. (c-d) Mean (+/- standard errors of the means over 20 m quadrats) of (c) AGB and (d) AWP in each topographically defined habitat. The AGB and AWP of individual trees were distributed among 2x2m pixels in proportion to the area of intersection between the pixel and the estimated tree crown [crown radius calculated according to @MartinezCano2019]. The AGB and AWP of the portions of tree crowns that lie outside the edges were mirror-transposed into the pixels inside the plot to avoid underestimation of AGB and AWP at the edges of the plot (see Supplementary material)."}
...
The aboveground woody biomass estimates provided in this chapter omit some forest biomass stocks and fluxes, which may vary in importance but are all relatively difficult to estimate accurately. Direct estimates of root biomass, which is probably the largest omitted biomass stock, require labor-intensive destructive sampling [@Addo-Danso2016]. Root biomass is therefore often estimated from above-ground biomass simply by multiplying by an estimated below-aboveground biomass ratio [@Addo-Danso2016;@Qi2019]. Average ratios of below-to-aboveground biomass in tropical forests vary between 0.2:1 and 0.31:1 in the literature [@Anderson-Teixeira2016;@Mokany2006;@Qi2019], which would result in a root biomass of about 60-90 Mg/ha in the Barro Colorado Island 50 ha plot. To date, there is no site-specific below-aboveground biomass ratio for BCI; harvests including below-ground biomass have been conducted at the nearby young secondary forest site of Agua Salud [@Sinacore2017], but ratios are expected to decrease with increasing tree height and forest maturity [@Qi2019;@Mokany2006]. [Esimtate of root turnover?] The biomass of lianas is also difficult to estimate, mainly due to the irregularity of their morphology which makes it difficult to estimate their biomass from simple measurements such as their diameter. Two complete censuses of lianas on the 50 ha plot have already been conducted and show that lianas account for only 3.3% of the total aboveground biomass (@Schnitzer2012;@Schnitzer2021; Chapter XX). Branchfalls, which are an important part of biomass turnover in tropical forests and account for about a fourth of the area of canopy gaps in BCI [@Araujo2021], are generally omitted from  [Saplings & trees < 1cm dbh?] Finally, non-woody biomass (leaves, flowers and fruits) generally represents 2-4% of the total aboveground biomass [xx and xx% of biomass turnover] in mature tropical forests [@Anderson-Teixeira2016;@Chave2010;@Muller-Landau2021]. 




> Conclusion? Perspectives referencing other chapters?
> remote sensing: more temporal and spatial coverage: disturbnace rates, canopy processes, landscape variation
