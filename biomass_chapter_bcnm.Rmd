...
The aboveground woody biomass estimates provided in this chapter omit some forest biomass pools, which may vary in importance but are all relatively difficult to estimate accurately. Direct estimates of root biomass, which is probably the largest omitted biomass stock, require labor-intensive destructive sampling [@Addo-Danso2016]. Root biomass is therefore often estimated from above-ground biomass simply by multiplying by an estimated below-aboveground biomass ratio [@Addo-Danso2016;@Qi2019]. Average ratios of below-to-aboveground biomass in tropical forests vary between 0.2:1 and 0.31:1 in the literature [@Anderson-Teixeira2016;@Qi2019], which would result in a root biomass of about 60-90 Mg/ha in the Barro Colorado Island 50 ha plot. To date, there is no site-specific below-aboveground biomass ratio for BCI; harvests including below-ground biomass have been conducted at the nearby young secondary forest site of Agua Salud [@Sinacore2017], but ratios are higher in younger trees and forests (REF). The biomass of lianas is also difficult to estimate, mainly due to the irregularity of their morphology which makes it difficult to estimate their biomass from simple measurements such as their diameter. Two complete censuses of lianas on the 50 ha plot have already been conducted and show that lianas account for only 3% of the basal area of all woody plants, which suggests they would be an even smaller proportion of the total aboveground biomass (@Schnitzer2012;@Schnitzer2021; Chapter XX). [Saplings & trees < 1cm dbh?] Finally, non-woody biomass (leaves, flowers and fruits) generally represents 2-4% of the total aboveground biomass in mature tropical forests [@Anderson-Teixeira2016;@Chave2010;@Muller-Landau2021]. 

> add: estimated biomass fluxes do not account for branchfalls, which are an important part of biomass turnover in tropical forests and account for about a fourth of the area of canopy gaps in BCI [@Araujo2021]
