...
```{r fig2-correc, fig.height = 10, fig.width = 12, fig.cap="Some examples of corrections on individual tree aboveground biomass (AGB; Mg) and AGB changes (Mg/yr), and their effect on total plot AGB (Mg/ha) and aboveground woody productivity (AWP; Mg/ha/yr)."}
...
levels(df_ind_melt$variable) <- list("DBH (cm)" = "dbh", 
                                     "HOM (m)" = "hom", 
                                     "AGB (Mg)" = "agb",
                                     "AWP (Mg/yr)" = "Dagb")
